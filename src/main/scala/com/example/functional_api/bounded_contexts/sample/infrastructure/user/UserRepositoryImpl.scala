...
import com.example.functional_api.bounded_contexts.sample.infrastructure.support.RepositoryBase
import doobie.implicits._
import doobie.util.transactor.Transactor
import fs2.Stream


class UserRepositoryImpl[F[+_] : Async : ContextShift](xa: Transactor[F]) extends RepositoryBase with UserRepository[F] {
